...
<body>
    ...
    <form method="post" action="{{ route('employe.update', $employe->id) }}" enctype="multipart/form-data">
        ...
        <div class="group">
            <input type="text" class="input" id="nom" name="nom" value="{{ $employe->nom }}">
        ...
        <div class="group">
            <input type="text" class="input" id="prenom" name="prenom" value="{{ $employe->prenom }}">
            <span class="bar"></span>
            <span class="highlight"></span>
            <label>Prénom</label>
        </div>
        ...
        <div class="group">
            <input type="email" class="input" id="email" name="email" value="{{ $employe->email }}">
            <span class="bar"></span>
            <span class="highlight"></span>
            <label>Email</label>
        </div>
